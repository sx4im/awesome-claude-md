...
- **Modal Serverless Compute**: Core framework and primary technology
...
Modal Serverless Compute-specific project structure with appropriate directories for the technology.
