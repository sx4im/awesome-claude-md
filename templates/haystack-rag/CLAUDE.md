...
- **Haystack RAG Framework**: Core framework and primary technology
...
Haystack RAG Framework-specific project structure with appropriate directories for the technology.
